...
<body>
    ...
    <main class="container mx-auto p-6">
        ...
        <section>
            <div class="container mx-auto p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php
                    $projects = Projet::getAllProjetss();
        ...
        <section id="ModelProjet" class=" fixed top-[30%] left-[34%] hidden">
            <form action="http://localhost/amine_Sabri_Project/index.php?action=createProjet" method="POST" class="relative bg-yellow-500 shadow-md rounded-lg w-[400px] px-8 pt-6 pb-8 mb-4">
                <div id="closeModelProjet" class="flex justify-end w-fit mb-[22px]  absolute left-[92%] bottom-[85%]">
                ...
                <div class="grid grid-cols-2 space-x-5">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            <select name="assignUsers[]" id="assignUsers" class="block appearance-none w-54 h-16 bg-white border border-gray-300 text-gray-700 py-1 px-2 rounded leading-tight focus:outline-none focus:shadow-outline" multiple>
                                <?php
                                    $users = User::getAll();
